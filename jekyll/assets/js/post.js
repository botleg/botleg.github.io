...
function addComment(e) {
	...
	xhr.open('POST', encodeURI('https://api.botleg.com/comments/'+window.location.pathname.split('/')[2]));
...
xhr.open('GET', encodeURI('https://api.botleg.com/comments/'+window.location.pathname.split('/')[2]));
xhr.onload = function() {
	if (xhr.status === 200) {
